...
class Home extends React.Component {
  ...
  onCompleteUploadModal() {
    ...
    reader.onerror = () => alert("Failed to upload the file!");
    reader.onload = () => {
  ...
  onInputFilter(e) {
    ...
    this.setState({
      ...
      displayedForms: this.state.forms.filter(
        (form) =>
          form.id.toString().toUpperCase().indexOf(filter.toUpperCase()) > -1 ||
      ...
      <div id="manager-panel">
        <div id="manager-panel-head">
          ...
          <Button
            variant="primary"
            size="lg"
            onClick={this.onOpenUploadModal.bind(this)}
          >
            +&nbsp;Upload&nbsp;New&nbsp;Form
          </Button>{" "}
        </div>
        <div id="manager-panel-body">
          <div id="manager-panel-body-head">
            <p>
              Displaying {this.state.displayedForms.length} of{" "}
                  ...
                  <tr key={form.id}>
                    ...
                    <td>
                      <Dropdown as={NavItem}>
                        ...
                        <Dropdown.Menu>
                          <Dropdown.Item
                            onClick={this.onDeleteForm.bind(this, form)}
                          >
                            Delete
                          </Dropdown.Item>
                          <Dropdown.Item
                            onClick={this.onOpenUploadModal.bind(this, form)}
                          >
                            Update
                          </Dropdown.Item>
                        </Dropdown.Menu>
          ...
          <Modal
            ...
            onHide={this.onCloseUploadModal.bind(this)}
          >
            ...
            <Modal.Footer>
              <Button
                variant="secondary"
                onClick={this.onCloseUploadModal.bind(this)}
              >
                Cancel
              </Button>
              <Button
                variant="primary"
                onClick={this.onCompleteUploadModal.bind(this)}
                disabled={this.state.completeUpload}
              >
                Upload
              </Button>
